...
<body>
  ...
  <div class="span8" id="main-content">
    ...
    <form class="form-horizontal" method="post" action="doentry.php" id="entryform">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="textbox" id="rollno" name="rollno"/><span id="rollnoduplicate" class="hidden">Roll no already present in the database !</span><span id="rollnoerror" class="hidden">Enter a valid rollno !</span>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <label class="checkbox inline">
          <input type="checkbox" id="qms" name="qms" value="QMS"/>QMS
        </label>  
        <label class="checkbox inline">
          <input type="checkbox" id="contents" name="contents" value="Contents"/>Contents
        </label>  
        <label class="checkbox inline">
          <input type="checkbox" id="karnival" name="karnival" value="Karnival"/>Karnival
        </label>  
        <label class="checkbox inline">
          <input type="checkbox" id="xceed" name="xceed" value="Xceed"/>Xceed
        </label>  
        <label class="checkbox inline">
          <input type="checkbox" id="projects" name="projects" value="Projects"/>Projects
        </label>  
        <label class="checkbox inline">
          <input type="checkbox" id="hr" name="hr" value="HR"/>HR
        </label>  
        <label class="checkbox inline">
          <input type="checkbox" id="media" name="media" value="Media"/>Media
        </label>  
        </div>
        <span id="teamerror" class="hidden">Please check atleast one team !</span>
      </div>
  ...
  if(isset($_SESSION['entryerror']))
    if($_SESSION['entryerror']==1)
    {
      ...
      if($_SESSION['rollnoduplicate']==1)
        echo "<script type='text/javascript'> showerror(5);</script>";
      else
        echo "<script type='text/javascript'> var x; x=document.getElementById('rollno'); x.value=\"".$_SESSION['prollno']."\"; </script>";
      ...
      if($_SESSION['teamerror']==1)
        echo "<script type='text/javascript'> showerror(6);</script>";      
      ...
      if($_SESSION['pqms']==1)
        echo "<script type='text/javascript'> var x; x=document.getElementById('qms'); x.checked=true; </script>";
        
      if($_SESSION['pcontents']==1)
        echo "<script type='text/javascript'> var x; x=document.getElementById('contents'); x.checked=true; </script>";
        
      if($_SESSION['pkarnival']==1)
        echo "<script type='text/javascript'> var x; x=document.getElementById('karnival'); x.checked=true; </script>";
        
      if($_SESSION['pxceed']==1)
        echo "<script type='text/javascript'> var x; x=document.getElementById('xceed'); x.checked=true; </script>";
        
      if($_SESSION['pprojects']==1)
        echo "<script type='text/javascript'> var x; x=document.getElementById('projects'); x.checked=true; </script>";
        
      if($_SESSION['phr']==1)
        echo "<script type='text/javascript'> var x; x=document.getElementById('hr'); x.checked=true; </script>";
        
      if($_SESSION['pmedia']==1)
        echo "<script type='text/javascript'> var x; x=document.getElementById('media'); x.checked=true; </script>";
